    ...
    render(...args) {
        return h.div(
            ...
            h.div(
                ...
                h.h3({ class: "mb-0 d-flex align-items-center justify-content-center" },
            ...
            h.div(
                ...
                // Progress bar
                h.div({ class: "progress mb-4", style: "height: 10px;" },
                    h.div({
                        class: `progress-bar ${this.count.value >= 0 ? 'bg-success' : 'bg-danger'}`,
